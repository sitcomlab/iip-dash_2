...
export function createClusterCustomIconGreen(cluster) {
...
export function createClusterCustomIconBusStop(cluster) {
  const count = cluster.getChildCount();
  if (count < 10) {
    return L.divIcon({
      html: renderToStaticMarkup(
...
export function createClusterCustomIconBlue(cluster) {
  const count = cluster.getChildCount();
  if (count < 10) {
    return L.divIcon({
      html: renderToStaticMarkup(
